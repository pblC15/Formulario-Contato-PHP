...
if((isset($_POST['email']) && !empty(trim($_POST['email']))) && (isset($_POST['mensagem']) && !empty(trim($_POST['mensagem'])))){
    ...
    $email = $_POST['email'];//Usando a função trim() para tirar os espaços
    $assunto =!empty($_POST['assunto']) ? utf8_decode($_POST['assunto']) : "Não Informado";
    $mensagem = $_POST['mensagem'];//Usando a função trim() para tirar os espaços
    ...
    $mail->Password   = 'p3563971';                             //Senha do email
